...
const modal = document.getElementById('pokemon-details-modal'); // Get the modal element
...
async function fetchPokemonData() {
    try {
        const response = await fetch('https://pokeapi.co/api/v2/pokemon?limit=151'); // Fetch all 151
